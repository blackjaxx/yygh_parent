...
CREATE DATABASE IF NOT EXISTS `yygh_cmn` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `yygh_cmn`;
...
) ENGINE=InnoDB row_format=dynamic DEFAULT CHARSET=utf8 COMMENT='组织架构表';
...
) ENGINE=InnoDB row_format=dynamic AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='医院设置表';

#
# Database "yygh_order"
#

CREATE DATABASE IF NOT EXISTS `yygh_order` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `yygh_order`;
...
) ENGINE=InnoDB row_format=dynamic AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
) ENGINE=InnoDB row_format=dynamic AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='支付信息表';
...
CREATE TABLE `refund_info` (
  ...
  KEY `idx_out_trade_no` (`out_trade_no`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB row_format=dynamic DEFAULT CHARSET=utf8 COMMENT='退款信息表';

#
# Database "yygh_user"
#

CREATE DATABASE IF NOT EXISTS `yygh_user` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `yygh_user`;
...
CREATE TABLE `patient` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB row_format=dynamic AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='就诊人表';
...
CREATE TABLE `user_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `uk_mobile` (`phone`)
) ENGINE=InnoDB row_format=dynamic AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
CREATE TABLE `user_login_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB row_format=dynamic AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='用户登录记录表';
